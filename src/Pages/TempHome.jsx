...
export default function TempHome({ title, subtitle }) {
  ...
  return (
    <main className="coming-soon">
      ...
      <div className="coming-soon__content">
        ...
        {/* Eyebrow */}
        <span className="label-lg color-primary-container coming-soon__eyebrow">
          Welcome to the
        </span>
        ...
        <div className="coming-soon__actions">
          <button className="ticket-button" onClick={() => navigate("/productions")} style={{ padding:"20px 60px", fontSize:20 }} >
            Enter
          </button>
        </div>
